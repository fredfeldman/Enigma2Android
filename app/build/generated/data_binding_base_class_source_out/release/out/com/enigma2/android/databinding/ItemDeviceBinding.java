...
public final class ItemDeviceBinding implements ViewBinding {
  ...
  private ItemDeviceBinding(@NonNull LinearLayout rootView, @NonNull TextView tvActiveIndicator,
      @NonNull TextView tvDeviceAddress, @NonNull TextView tvDeviceName) {
    this.rootView = rootView;
    this.tvActiveIndicator = tvActiveIndicator;
  ...
  public static ItemDeviceBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.tv_active_indicator;
      TextView tvActiveIndicator = ViewBindings.findChildViewById(rootView, id);
      if (tvActiveIndicator == null) {
        break missingId;
      }
      ...
      return new ItemDeviceBinding((LinearLayout) rootView, tvActiveIndicator, tvDeviceAddress,
          tvDeviceName);
    }
