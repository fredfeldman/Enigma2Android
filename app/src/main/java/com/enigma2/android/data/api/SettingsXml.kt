...
import com.enigma2.android.data.model.settings.ConfigItem
...
import com.enigma2.android.data.model.settings.PowerState
import com.enigma2.android.data.model.settings.ProtectedService
import com.enigma2.android.data.model.settings.RecordingLocations
import com.enigma2.android.data.model.settings.SleepTimer
import com.enigma2.android.data.model.settings.StatusInfo
import com.enigma2.android.data.model.settings.TunerSignal
import com.enigma2.android.data.model.settings.VolumeInfo
import com.enigma2.android.data.model.settings.WolSetup
...
object SettingsXml {
    ...
    fun parsePowerState(stream: InputStream): PowerState {
        ...
        // Try JSON first, fall back to XML <e2instandby>true</e2instandby>
        try {
            val o = JSONObject(body)
            return PowerState(
    ...
    fun parseConfigSection(name: String, stream: InputStream): ConfigSection {
        ...
        try {
            // OpenWebif returns either {"section":[items]} or a top-level array
